...
| `tokmem` | `qwen0_5b` | `8` | `64` | `64` | TokMem family, `gradient_accumulation_steps=1` |
| `tokmem` | `llama3b` | `4` | `32` | `32` | TokMem family, `gradient_accumulation_steps=1` |
| `tokmem` | `llama8b` | `2` | `16` | `16` | TokMem family, `gradient_accumulation_steps=2` |
| `tokmem_logit_bias` | `qwen0_5b` | `8` | `64` | `64` | `use_logit_bias`, `gradient_accumulation_steps=1` |
| `tokmem_logit_bias` | `llama3b` | `4` | `32` | `32` | `use_logit_bias`, `gradient_accumulation_steps=1` |
| `tokmem_logit_bias` | `llama8b` | `2` | `16` | `16` | `use_logit_bias`, `gradient_accumulation_steps=2` |
...
- 方法：`icl`、`rag`、`lora`、`tokmem`、`tokmem_eoc`、`tokmem_eoc_logit_bias`、`adap_tokmem`、`adap_tokmem_eoc`、`adap_tokmem_eoc_logit_bias`
...
`4calls` 覆盖全部 compositional 方法；`10calls` stress-test 覆盖 `tokmem`、`tokmem_eoc_logit_bias`、`adap_tokmem`、`adap_tokmem_eoc_logit_bias`。
