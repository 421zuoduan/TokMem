...
run_name=tapmem_llama8b_residualroute_tcra_aligned_nokeep_e100_seed42_v2
...
cd "$repo_dir"
echo "[$(date --iso-8601=seconds)] starting aligned-TCRA TapMem training on GPU $train_gpu"
