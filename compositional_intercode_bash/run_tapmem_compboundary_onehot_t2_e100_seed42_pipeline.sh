...
run_name=tapmem_llama8b_compboundary_onehot_t2_e100_seed42_v1
...
cd "$repo_dir"
echo "[$(date --iso-8601=seconds)] starting compositional-boundary TapMem scale=2 training on GPU $train_gpu"
