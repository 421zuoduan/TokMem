...
SUITE_NAME="paper_compositional_logit_bias_scale_ablation_llama1b_4calls_8gpu_${SUITE_TIMESTAMP}"
...
' _ "$ROOT_DIR/scripts/compositional/llama_1b/rerun_paper_compositional_logit_bias_scale_ablation.sh" "$SUITE_NAME" > "$LOG_FILE" 2>&1 &
