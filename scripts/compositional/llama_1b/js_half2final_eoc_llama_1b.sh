...
OUTPUT_DIR="$ROOT_DIR/compositional/runs/js_half2final_explore/js_half2final_eoc_llama_1b_${RUN_ID}"
...
python compositional/utils/js_half2final_explore.py \
    --checkpoint_path "$ROOT_DIR/compositional/runs/eoc_only_llama_1b_50tools_20260412_105149/round_1_tools_51_100.pt" \
