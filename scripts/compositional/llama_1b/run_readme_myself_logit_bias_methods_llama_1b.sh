...
RUN_NAME="readme_myself_logit_bias_methods_llama_1b_${RUN_ID}"
...
for setting_entry in "${SETTINGS[@]}"; do
    ...
    for seed in "${TRIAL_SEEDS[@]}"; do
        ...
        trial_name="readme_myself_logit_bias_methods_setting${setting_id}_trial${trial_index}_${RUN_ID}"
        ...
        cmd=(
            ...
            --run_name "$trial_name"
            --run_tag "readme_myself_logit_bias_methods_setting${setting_id}"
        )
