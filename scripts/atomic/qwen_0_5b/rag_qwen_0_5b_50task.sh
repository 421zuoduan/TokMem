...
CORPUS_CACHE="${REPO_ROOT}/atomic/cached_splits/${SPLIT_NAME}/rag_corpus_all-MiniLM-L6-v2_top3.pt"
...
RUN_NAME="rag_qwen_0_5b_${NUM_TASKS}task_${RUN_ID}"
