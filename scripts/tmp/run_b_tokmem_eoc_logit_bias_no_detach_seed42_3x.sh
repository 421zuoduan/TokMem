...
METHOD_NAME="b_tokmem_eoc_logit_bias_no_detach_llama_1b"
RUN_NAME_PREFIX="tokmem_eoc_logit_bias_no_detach_llama_1b_50tools"
RUN_TAG="llama_1b_eoc_logit_bias_no_detach"
...
METHOD_FLAGS=(--use_eoc --use_logit_bias --no-detach)
