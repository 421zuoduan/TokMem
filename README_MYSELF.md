...
| 实验编号 | 模式 | epochs | lr | eoc | gate | eoc loss | task loss | eoc loss weight | tool loss weight | gate loss weight | Tool Prediction Acc | Tool F1 | Arguments F1 | Exact Match Acc | Parse Error Rate |
| --- | --- | ---: | ---: | --- | --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `1` | baseline | 3 | 0.005 | × | × | × | × |  |  |  | 0.595 | 0.838 | 0.674 | 0.394 | 0.554 |
| `2` | eoc-only | 3 | 0.005 | √ | × | × | × |  |  |  | 0.630 | 0.871 | 0.714 | 0.455 | 0.892 |
| `3` | eoc+gate | 3 | 0.005 | √ | √ | × | × |  |  | 0.1 | 0.606 | 0.859 | 0.701 | 0.434 | 1.106 |
| `4` | eoc-only | 3 | 0.005 | √ | × | √ | × | 0.1 |  |  | 0.638 | 0.871 | 0.718 | 0.456 | 0.708 |
| `5` | eoc+gate | 3 | 0.005 | √ | √ | √ | × | 0.1 |  | 0.1 | 0.612 | 0.855 | 0.693 | 0.424 | 1.694 |
| `6` | eoc-only | 3 | 0.005 | √ | × | √ | √ | 0.1 | 0.1 |  | 0.646 | 0.881 | 0.673 | 0.413 | 3.180 |
| `7` | eoc+gate | 3 | 0.005 | √ | √ | √ | √ | 0.1 | 0.1 | 0.1 | 0.639 | 0.882 | 0.671 | 0.408 | 2.222 |

- 自动生成自 `compositional/runs/readme_myself_7settings_llama_1b_20260415_170743`。
