...
def main():
    ...
    parser.add_argument(
        "--compute_memory_bank_geometry_stats",
        type=parse_bool_arg,
        default=False,
        metavar="BOOL",
